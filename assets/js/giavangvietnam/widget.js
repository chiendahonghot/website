...
function priceChangeFormat(num,change){if(num!=0&&num!=''){var price=formatNumberK(formatNumber(num));return(change=='up'?'â–²':'â–¼')+price;}
return '';}
...
return positions;},labels:{}},yAxis:{title:{text:''}},tooltip:{shared:true,crosshairs:true,formatter:function(){return '<span> NgÃ y: '+this.x+'</span><br>'+
...
'<span >ChÃªnh lá»‡ch</span>'+': '+'<strong>'+formatNumberK(formatNumber(this.points[1].y-this.points[0].y))+'</strong>';}},series:[{name:'Mua vÃ o',color:'#f13628',data:buyJson},{name:'BÃ¡n ra',color:'#258a29',data:sellJson}]};Highcharts.chart(drawToViewId,options);}})(jQueryhighcharts);jQueryhighcharts(document).ready(function(){highChartHomeModule.init();});}
		...
		`,HTML_Literal:`
			<div class="{{WIDGET_CLASS_ID}}-base">
				<div class="{{WIDGET_CLASS_ID}}-chart">
					<p class="{{WIDGET_CLASS_ID}}-widget-header"><a href="/search/label/Giá%20vàng%20SJC" target="_blank">GiÃ¡ vÃ ng SJC</a></p>
				...
				<div class="{{WIDGET_CLASS_ID}}-sjc">
					<p class="{{WIDGET_CLASS_ID}}-widget-header"><a href="/search/label/Giá%20vàng" target="_blank">GiÃ¡ vÃ ng trong nÆ°á»›c</a></p>
				...
				<div class="{{WIDGET_CLASS_ID}}-xauusd">
					<p class="{{WIDGET_CLASS_ID}}-widget-header"><a href="/search/label/Giá%20vàng%20thế%20giới" target="_blank">GiÃ¡ vÃ ng tháº¿ giá»›i</a></p>
					<div class="{{WIDGET_CLASS_ID}}-xau-usd"><p class="{{WIDGET_CLASS_ID}}-xau-usd-type">XAUUSD</p><p class="{{WIDGET_CLASS_ID}}-xau-usd-description">VÃ ng/ÄÃ´ la Má»¹</p><p class="{{WIDGET_CLASS_ID}}-price-detail"> <span class="{{WIDGET_CLASS_ID}}-xau-usd-price">-</span> <span class="{{WIDGET_CLASS_ID}}-xau-usd-change">-</span></p></div>
				</div>
				<div class="{{WIDGET_CLASS_ID}}-exchange">
					<p class="{{WIDGET_CLASS_ID}}-widget-header"><a href="/search/label/Giá%20vàng%20thế%20giới" target="_blank">Quy Ä‘á»•i vÃ ng tháº¿ giá»›i</a></p>
					<table width="100%"><tbody><tr><td class="{{WIDGET_CLASS_ID}}-usd-title {{WIDGET_CLASS_ID}}-usd-unit-gold">Gold</td><td class="{{WIDGET_CLASS_ID}}-usd-unit {{WIDGET_CLASS_ID}}-usd-unit-gold-value"></td></tr><tr><td class="{{WIDGET_CLASS_ID}}-usd-title {{WIDGET_CLASS_ID}}-usd-unit-tygia">Tá»· giÃ¡ USD</td><td class="{{WIDGET_CLASS_ID}}-usd-unit {{WIDGET_CLASS_ID}}-usd-unit-rate-value"></td></tr><tr><td class="{{WIDGET_CLASS_ID}}-usd-title {{WIDGET_CLASS_ID}}-usd-unit-quydoi">Quy Ä‘á»•i</td><td class="{{WIDGET_CLASS_ID}}-usd-unit {{WIDGET_CLASS_ID}}-usd-unit-exchange-value"></td></tr><tr><td class="{{WIDGET_CLASS_ID}}-usd-title {{WIDGET_CLASS_ID}}-usd-unit-chenhlech">ChÃªnh lá»‡ch</td><td class="{{WIDGET_CLASS_ID}}-usd-unit {{WIDGET_CLASS_ID}}-usd-unit-difference-value"></td></tr></tbody></table>
				</div>
				<div class="{{WIDGET_CLASS_ID}}-copyright">Cáº­p nháº­t: <span class="{{WIDGET_CLASS_ID}}-update-time">-</span><br/>Tá»•ng há»£p bá»Ÿi <a href="/" target="_blank">GiÃ¡ VÃ ng Viá»‡t Nam</a>
				</div>
			</div>
