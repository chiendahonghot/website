...
'<span >ChÃªnh lá»‡ch</span>'+': '+'<strong>'+formatNumberK(formatNumber(this.points[1].y-this.points[0].y))+'</strong>';}},series:[{name:'Mua vào',color:'#f13628',data:buyJson},{name:'Bán ra',color:'#258a29',data:sellJson}]};Highcharts.chart(drawToViewId,options);}})(jQueryhighcharts);jQueryhighcharts(document).ready(function(){highChartHomeModule.init();});}
